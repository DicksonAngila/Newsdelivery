                    ...
                    <ul class="collapsible collapsible-accordion">
                        <li class="bold"><a class="collapsible-header waves-effect waves-cyan"><i class="mdi-action-question-answer"></i>Feedback</a>
                            <div class="collapsible-body">
								...
								<?php
									$sql = mysqli_query($con, "SELECT DISTINCT status FROM feedback WHERE poster_id = $user_id AND not deleted;");
									while($row = mysqli_fetch_array($sql)){
...
<i class="mdi-content-send right"></i>
  ...
  <footer class="page-footer">
    <div class="footer-copyright">
      <div class="container">
        <span>Copyright © KCNDS <a class="grey-text text-lighten-4" href="#" target="_blank">KCNDS</a> 
        </div>
    </div>
  </footer>
    <!-- END FOOTER -->
