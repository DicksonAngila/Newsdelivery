    ...
    <div class="wrapper">
      ...
      <aside id="left-sidebar-nav">
        <ul id="slide-out" class="side-nav fixed leftside-navigation">
            ...
            <li class="bold"><a href="index.php" class="waves-effect waves-cyan"><i class="mdi-editor-border-color"></i>Newspaper Types</a>
            </li>
                <li class="no-padding">
                 ...
                 <li class="no-padding">
                    <ul class="collapsible collapsible-accordion">
                        <li class="bold"><a class="collapsible-header waves-effect waves-cyan"><i class="mdi-action-question-answer"></i>Feedback</a>
                            <div class="collapsible-body">
                                <ul>
								<li><a href="all-feedback.php">All Feedback</a>
                                </li>
								<?php
                            ...
                            <span>Kshs. '.$row1['price'].'</span>
								...
								echo'<li class="collection-item">
                                        <div class="row">
                                            ...
                                            <div class="col s3">
                                                <span><strong>Kshs. '.$row['total'].'</strong></span>
                                            </div>';										
								if(!$deleted){
